                            ...
                            nisn: {
                                validators: {
                                    ...
                                    remote: {
                                        ...
                                        method: 'POST',
                                        url: HOST_URL + 'employee/master/student/check_nisn_student',
                                        data: function () {
                                            return {
...
//                                    },
                            ...
                            password: {
                                validators: {
                                    ...
                                    identical: {
                                        compare: function () {
                                            return _formEl.querySelector('[name="cf_password"]').value;
                                        },
            ...
            _validations[3].disableValidator('password').disableValidator('cf_password');

            $(".ubahpass").on("switchChange.bootstrapSwitch", function (event, state) {
                if (state == true) {
                    _validations[3].enableValidator('password').enableValidator('cf_password');
