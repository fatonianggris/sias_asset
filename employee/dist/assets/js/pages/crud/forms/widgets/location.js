...
function initialize() {
    var myLatlng = new google.maps.LatLng(-7.3119968, 112.6569991);
    var mapOptions = {
        zoom: 12,
        center: myLatlng,
    ...
    $.ajax({
        url: HOST_URL + "employee/configuration/datalocation/showAllDataLocation",
        type: "get",
...
function getPolygonCoordsFirst() {
    ...
    stringMD5 += "]";
    $.ajax({
        url: HOST_URL + "employee/configuration/datalocation/storeMd5Location",
        type: "post",
        data: {'md5': stringMD5},
        success: function (response) {
            // Success
...
function notif() {
    Swal.fire({
        text: "Berhasil!, penentuan area map untuk absen telah tersimpan.",
        icon: "success",
...
function saveLocation(latLongt) {
    ...
    $.ajax({
        url: HOST_URL + "employee/configuration/datalocation/storeLocation",
        type: "post",
        data: data,
        success: function (response) {
        },
...
function deleteLocationTable() {
    ...
    $.ajax({
        url: HOST_URL + "employee/configuration/datalocation/deleteLocationTable",
        type: "post",
        success: function (response) {
            // Success
        },
