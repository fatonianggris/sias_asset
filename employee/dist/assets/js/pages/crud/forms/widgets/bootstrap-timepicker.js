...
// Class definition
    ...
    var KTBootstrapTimepicker = function () {
        ...
        var demos = function () {
            ...
            // minimum setup
            $('#kt_timepicker_start, #kt_timepicker_start_modal').timepicker({
                minuteStep: 1,
                defaultTime: '',
                showSeconds: true,
                showMeridian: false,
            ...
            // minimum setup
            $('#kt_timepicker_end, #kt_timepicker_end_modal').timepicker({
                minuteStep: 1,
                defaultTime: '',
                showSeconds: true,
                showMeridian: false,
            ...
            // minimum setup
            $('#kt_timepicker_tolerance, #kt_timepicker_tolerance_modal').timepicker({
                minuteStep: 1,
                defaultTime: '',
                showSeconds: true,
                showMeridian: false,
