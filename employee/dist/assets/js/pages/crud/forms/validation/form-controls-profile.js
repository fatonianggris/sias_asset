...
// Class definition
    var KTFormControls = function () {
        ...
        var _initPegawai = function () {
            const form = document.getElementById('kt_form_profile');
                            ...
                            nik: {
                                validators: {
                                    ...
                                    remote: {
                                        ...
                                        method: 'POST',
                                        url: HOST_URL + 'employee/settings/account/check_nik_profile',
                                        data: function () {
                                            return {
                            ...
                            nip: {
                                validators: {
                                    ...
                                    remote: {
                                        ...
                                        method: 'POST',
                                        url: HOST_URL + 'employee/settings/account/check_nip_profile',
                                        data: function () {
                                            return {
